...
mask =(zeros(nvx,nvy)); mask(:,1:R:stop1) = 0; mask(:,ACS_region) = 1; mask(:,stop2:R:nvy) = 1;
...
Recon_Im = POCS_Func(kData1,mask);subplot(1,4,3);imagesc(abs(Recon_Im));axis square;colormap gray;axis off;title('Homodyne Reconstructed Image');
